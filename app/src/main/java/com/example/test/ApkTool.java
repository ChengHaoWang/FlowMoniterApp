...
*/
    ...
    public static String getFlowFromByte(long totalByte){
        ...
        //BigDecimal kb = new BigDecimal(totalKb);
        //double totalKb1 = kb.setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        double totalKb1 = totalB.divide(kb, 1, BigDecimal.ROUND_HALF_UP).doubleValue();

        //float totalMb =totalByte/(1024*1024);
        //BigDecimal mb = new BigDecimal(totalMb);
        //double totalMb1 = mb.setScale(1, BigDecimal.ROUND_HALF_UP).doubleValue();
        double totalMb1=totalB.divide(mb, 1, BigDecimal.ROUND_HALF_UP).doubleValue();

        //float totalGb =totalByte/(1024*1024*1024);
